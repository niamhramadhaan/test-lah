  ...
  },
  {
    icon: (
      ...
      >
        ...
        <circle cx="12" cy="12" r="2" fill="#6F4E37" />
      </svg>
    ),
    bg: "#EDE6DD",
  },
  ...
  },
  {
    icon: (
      ...
      >
        ...
        <path d="M2 12l10 5 10-5" fill="#6F4E37" opacity="0.15" />
      </svg>
    ),
    bg: "#F7F3EE",
  },
  {
    icon: (
      ...
      >
        ...
        <circle cx="12" cy="12" r="1" fill="#6F4E37" />
      </svg>
    ),
    bg: "#F5F0EB",
  },
...
export function DashboardHeader() {
  ...
  const stats = useMemo(() => {
    const allCases = projectList.flatMap((p) =>
      Object.values(p.testCases).flat(),
    );
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between px-6 py-2.5">
        <div className="flex items-center gap-3">
          <Link href="/projects" className="flex items-center gap-2">
            ...
            <span
              ...
              style={{
                background:
                  "linear-gradient(90deg, var(--text-primary) 0%, var(--text-primary) 40%, #FFD54F 50%, var(--text-primary) 60%, var(--text-primary) 100%)",
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="hidden md:block px-3 py-1.5 text-[11px] font-medium rounded-md border transition-colors hover:bg-[var(--bg-secondary)]"
            style={{
              borderColor: "var(--border)",
          ...
          <button
            ...
            className="w-8 h-8 flex items-center justify-center text-xs rounded-md border transition-colors hover:bg-[var(--bg-secondary)] hover:border-[var(--status-fail-text)]"
            style={{
              borderColor: "var(--border)",
          ...
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path
                d="M5 2H3.5A1.5 1.5 0 002 3.5v7A1.5 1.5 0 003.5 12H5M9 10l3-3-3-3M6 7h6"
                stroke="currentColor"
                strokeWidth="1.3"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      {/* Nav items row */}
      <div className="relative z-10 flex items-center gap-1 px-6">
        <NavItem
          label="All Projects"
          href="/projects"
          icon={
